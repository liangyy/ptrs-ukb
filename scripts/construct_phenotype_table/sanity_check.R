# This file is for manual and dirty check
# not really used for anything serious
...
tmp1 = tmp1[match(tmp2$eid, tmp1$eid), ]
tmp2 = tmp2[match(tmp1$eid, tmp2$eid), ]
sum(tmp1 != tmp2)

# extra check used for previous tables. 
# now the tables have been updated.
# no need anymore
# 
