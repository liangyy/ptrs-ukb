...
if [[ ! -f ../../output/new_query_phenotypes_with_population_qc.rds ]] || [[ ! -z $1 ]]
then
  Rscript new_pop_qc.R \
    ../../output/query_phenotypes_output.csv \
    ../../output/new_query_phenotypes_with_population_qc.rds
...
if [[ ! -f ../../output/new_query_phenotypes_cleaned_up.csv ]] || [[ ! -z $1 ]]
then
  Rscript ../construct_phenotype_table/phenotype_qc.R \
    ../../output/new_query_phenotypes_with_population_qc.rds \
    ../../output/new_query_phenotypes_cleaned_up.csv
...
if [[ ! -d ../../output/new_data_split/ ]] || [[ ! -z $1 ]]
then
