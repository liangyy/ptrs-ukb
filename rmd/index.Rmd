...
* REML on 10 tissues CTIMP models (GTEx V8) [link](regulability_ctimp.html)
* REML on MESA models with common genes [link](regulability_mesa_common_genes.html)

# PRS/PTRS results

* First look at PTRS/PRS on GTEx V8 whole blood CTIMP model [link](first_look_at_ptrs_prs.html)
* MESA PTRS [link](first_look_at_mesa_ptrs.html)
* PTRS with LD block based pruning or mashr p-value [link](first_look_at_ldblock_ptrs.html) 
