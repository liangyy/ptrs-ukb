...
info = info %>% select(Field, id, phenotype_tag) 
colnames(info) = c('UKB Field Description', 'UKB Field ID', 'Tag')

### save as tex table
print(
  xtable::xtable(info, display=c("s", "s", "s", "s"), caption = '\\textbf{Meta information of the phenotypes retrieved from UK Biobank which were used in the analysis}. The \`\`Tag\'\' column shows the short name of the phenotyes used in this paper.', label = 'tab:trait_table', digits = 5), 
